                ...
                @forelse($users as $user)
                    <tr>
                        <td style="font-weight:600;">
                            ...
                            {{ $user->full_name }}
                            @if($user->id === auth()->id())
                                <span style="font-size:11px; color:#9ca3af; font-weight:400;">(You)</span>
                            @endif
                        </td>
                        ...
                        <td>
                            <div style="display:flex; gap:6px;">
                                ...
                                @if($user->id !== auth()->id())
                                    ...
                                    {{-- Delete button --}}
                                    <form method="POST" action="{{ route('admin.users.destroy', $user) }}" onsubmit="return confirm('Deactivate {{ $user->full_name }}?')">
                                        @csrf
                                        @method('DELETE')
